...
## Input :          path
## Output :         Copy files from one directory to another
## Description :    This Script is used to copy files from one directory and to paste into another directory
...
def main():
    ...
    if (argv[1] == "-h") or (argv[1] == "-H"):
        print("This Script is used to copy files from one directory and to paste into another directory")
        exit()

    if (argv[1] == "-u") or (argv[1] == "-U"):
        print("Usage : Application_Name Copy_Files_From_One_Directory_To_Another")
        exit()
